...
namespace CGP
{
    public partial class SimpleDrawing : Form
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            DrawCircleInSquare(g, blackPen, 280, 360, 110);
        }

        // circle fits inside square when both share the same bounding rectangle
        private void DrawCircleInSquare(Graphics g, Pen pen, int x, int y, int side)
        {
